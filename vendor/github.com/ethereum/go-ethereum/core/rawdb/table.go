...
func (t *table) NewBatchCF(cf string) ethdb.Batch {
	return nil
}
...
func (t *table) PutCF(cf string, key []byte, value []byte) error {

	return nil
}
func (t *table) GetCF(cf string, key []byte) ([]byte, error) {
	return nil, nil
...
func (b *tableBatch) PutCF(cf string, key []byte, value []byte) error {
...
func (r *tableReplayer) PutCF(cf string, key []byte, value []byte) error {
